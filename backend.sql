...
CREATE TYPE product_status_enum AS ENUM ('draft', 'active', 'inactive', 'removed', 'archived');

CREATE TYPE moderation_status_enum AS ENUM ('pending', 'approved', 'rejected');

CREATE TYPE order_status_enum AS ENUM ('created', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'failed');
