...
FROM (
    VALUES
        ('striped-knit-polo-shirt', 'fashion', TRUE),
        ('studded-cotton-crew-tee', 'fashion', TRUE),
        ('baggy-tokyo-racing-graphic-jersey', 'fashion', TRUE),
        ('boxy-heavyweight-graphic-cutoff-tank', 'fashion', TRUE),
        ('evolution-straight-leg-sweatpants', 'fashion', TRUE),
        ...
        ('loose-fit-scuba-baseball-jacket', 'fashion', TRUE),
        ...
        ('eyelet-bustier-flounce-mini-dress', 'fashion', TRUE),
        ('adizero-adios-pro-4', 'fashion', TRUE),
        ('superstar-ii', 'fashion', TRUE),
        ('adicolor-classic-trefoil-baseball-cap', 'fashion', TRUE),
        ('striped-knit-polo-shirt', 'men', FALSE),
        ('studded-cotton-crew-tee', 'men', FALSE),
        ('baggy-tokyo-racing-graphic-jersey', 'men', FALSE),
        ('boxy-heavyweight-graphic-cutoff-tank', 'men', FALSE),
        ('evolution-straight-leg-sweatpants', 'men', FALSE),
        ...
        ('eyelet-bustier-flounce-mini-dress', 'women', FALSE),
        ('adizero-adios-pro-4', 'women', FALSE),
        ('superstar-ii', 'women', FALSE),
        ('adicolor-classic-trefoil-baseball-cap', 'women', FALSE),
        ('striped-knit-polo-shirt', 'tops', FALSE),
        ('studded-cotton-crew-tee', 'tops', FALSE),
        ('baggy-tokyo-racing-graphic-jersey', 'tops', FALSE),
        ('boxy-heavyweight-graphic-cutoff-tank', 'tops', FALSE),
        ...
        ('eyelet-bustier-flounce-mini-dress', 'tops', FALSE),
        ('evolution-straight-leg-sweatpants', 'bottoms', FALSE),
        ...
        ('loose-fit-scuba-baseball-jacket', 'outerwear', FALSE),
        ...
        ('adicolor-classic-trefoil-baseball-cap', 'accessories', FALSE)
